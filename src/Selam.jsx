...
import briyani6 from "./assets/briyani6.jpg";
import briyani2 from "./assets/briyani2.jpg";
import briyani3 from "./assets/briyani3.jpg";
import briyani4 from "./assets/briyani4.jpg";
import briyani5 from "./assets/briyani5.jpg";
...
function Selam() {
  ...
  const dispatch= useDispatch()
    ...
    const [inCart, setInCart] = useState(Array(foods.length).fill(false));
    ...
    <div className="mx-auto max-w-[1300px]">
      ...
      <div className="flex items-center font-light shadow-xl px-4 py-2">
        ...
        <ul className="flex gap-10 ml-auto items-center mr-3 ">
          ...
          <Link to="/CartPage"><li className="flex items-center gap-2 font-bold hover:text-orange-500 cursor-pointer">
      ...
      <p className="text-[10px] mt-10 ml-[280px] hover:text-orange-500">
        Home / Selam / SELAM RR BRIYANI
      </p>

      {/* Restaurant Info */}
      <p className="font-bold text-3xl mt-[30px] ml-[280px]">SELAM RR BRIYANI</p>
      <div className="w-[750px] h-[180px] ml-[280px] mt-10 px-5 py-5 rounded-[40px] shadow-2xl">
        <div className="flex">
          <img src={star} className="w-[18px] h-[18px]" />
          <p className="ml-2 font-bold">4.4 (2.1K+ ratings) • ₹300 for two</p>
        </div>
      ...
      {/* Food Items */}
      <p className="text-lg font-bold mt-10 ml-[200px]">Biryani (16)</p>
      <div>
        {foods.map((food, index) => (
          ...
          >
            <p className="text-lg font-bold -mt-40">{food.name}</p>
            <p className="text-lg font-bold">{food.price}</p>

            <div className="flex items-center mt-2">
              <img className="w-[15px] h-[15px] " src={star1} alt="star" />
              <p className="text-green-900 font-bold ml-2">{food.rating}</p>
            </div>

            <p className="text-sm mt-2">{food.desc}</p>
