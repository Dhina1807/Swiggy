      ...
      {cartItems.length === 0 ? (
        ...
        <div className="bg-gray-300 ">
                    ...
                    <div className="flex shadow-lg bg-white py-4 ">
                     ...
                     <Link to="/Burger"><img className="w-[20px] h-[20px] ml-10"  src={home}/>
                    ...
                    <div className="bg-white">
                      <div className="mt-10 border border-white w-[750px] h-[200px] bg-white ml-[20px] ">
                        ...
                        <div className="mt-10 border border-white w-[750px] h-[100px] bg-white ml-[20px] ">
                         ...
                         <p className="ml-[150px] -mt-[120px]  font-bold text-2xl">Selam RR Biryani </p>
              {cartItems.map((item, index) => ( 
                <div key={index} className="grid grid-cols-1 mb-15  mt-5">
                      ...
                      <hr className="mt-5"/>
                          ...
                          <button  onClick={()=>[notify(),removeitem(index)]}className="bg-green-800  -mt-[40px]  ml-[200px] w-[80px] h-[40px] rounded-lg hover:bg-emerald-800 text-white text-sm font-bold">Confirm</button>
